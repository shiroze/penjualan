...
<script type="text/javascript">
	$(function(){
		...
		<?php
			$sqlTags = mysqli_query($id_mysql,"SELECT no_transaksi FROM tb_penjualan 
	    ...
	    <?php
			$sqlTagsb = mysqli_query($id_mysql,"SELECT * FROM tb_barang 
								ORDER BY kode_barang ASC") or die(mysqli_error());

			$tagsb = array();
			while($b = mysqli_fetch_assoc($sqlTagsb))
			{
