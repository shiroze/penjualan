	...
	switch ($act) {
			...
			echo"<div class='w3-row-padding'>
				...
				<div style='border-bottom:1px dashed #ccc;'></div>";
					...
					<table class='w3-table w3-striped w3-bordered w3-tiny w3-hoverable tbl'>
						...
						$sql_kul = mysqli_query($id_mysql,$query);
						...
						if($fd_kul > 0)
						{
							...
							$jmldata = mysqli_num_rows(mysqli_query($id_mysql,$q));
				...
				<div style='border-bottom:1px dashed #ccc;'></div><br>";
					echo"<table class='w3-table w3-tiny w3-hoverable tbl'>
						...
						$sql_tmp = mysqli_query($id_mysql,"SELECT a.kode_barang, a.qty, a.harga, b.nama_barang, a.disc 
		...
		case "printout" :
			...
			if(isset($_GET['id']))
			{
				...
				$sqltrans = mysqli_query($id_mysql,"SELECT * FROM tb_penjualan WHERE no_transaksi = '$_GET[id]'") or die(mysqli_error());
				...
				$sql = mysqli_query($id_mysql,"SELECT a.*, b.nama_barang, b.satuan 
									FROM tb_detail_penjualan a LEFT JOIN tb_barang b 
									ON a.kode_barang = b.kode_barang
									WHERE a.no_transaksi = '$_GET[id]'") or die(mysqli_error());
				$sub_total = 0;
				$total = 0;
				$no = 1;
...
<script type="text/javascript">
	$(function(){
		...
		<?php
			$sqlTags = mysqli_query($id_mysql,"SELECT * FROM tb_pelanggan 
								ORDER BY kode_pelanggan ASC") or die(mysqli_error());
