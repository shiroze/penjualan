<?php
	...
	if($mod == "pelanggan" AND $act == "simpan")
	{
		...
		mysqli_query($id_mysql,"INSERT INTO tb_pelanggan('kode_pelanggan', 
										nama_pelanggan, 
										nomor_telp, 
										alamat)
	...
	elseif ($mod == "pelanggan" AND $act == "edit") 
	{
		...
		mysqli_query($id_mysql,"UPDATE tb_pelanggan SET 
										nama_pelanggan= '$nama_pelanggan', 
										nomor_telp= '$nomor_telp', 
										alamat= '$alamat' 
					WHERE kode_pelanggan = '$_POST[id]'") or die(mysqli_error());
	...
	{
		mysqli_query($id_mysql,"DELETE FROM tb_pelanggan WHERE kode_pelanggan = '$_GET[id]'") or die(mysqli_error());
